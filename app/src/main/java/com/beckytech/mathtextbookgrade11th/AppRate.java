...
public class AppRate {
    private final static String APP_TITLE = "Maths Textbook Grade 11th";// App Name
    private static final String APP_PNAME = "com.beckytech.mathtextbookgrade11th";// Package Name
